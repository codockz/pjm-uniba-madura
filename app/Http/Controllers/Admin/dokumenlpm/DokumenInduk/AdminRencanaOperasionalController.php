...
class AdminRencanaOperasionalController extends Controller
{
    ...
    {
        $data = RencanaOperasional::orderBy('tahun', 'desc')
            ->latest()
            ->paginate(5);
    ...
    {
        return view('admin.dokumen_lpm.dokumen_induk.rencana_operasional.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        $filePath = $request->file('file')->store('rencana_operasional', 'public');
        ...
        return redirect()->route('admin.rencana_operasional.index')
