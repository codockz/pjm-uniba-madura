                ...
                <div class="col-xs-6 col-sm-4">
                    <div class="related_post_sec single_post">
                        ...
                        <span class="date-wrapper">
                            <span class="date">
                                <span>{{ date('d', strtotime($m->tanggal)) }}</span>
                        ...
                        <div class="rel_right">
                            <h4>
                                <a href="{{ route('frontend.showPengumuman', $m->slug) }}">
                                    {{ $m->judul }}
                                </a>
                            </h4>
                            ...
                            <div class="meta">
                                ...
                                <span class="event-time">
                                    <i class="fa fa-clock-o"></i>{{ \Carbon\Carbon::parse($m->jam)->format('H:i') }}
                                </span>
                            </div>

                            <p>{{ Str::limit($m->isi, 250) }}</p>

                            <a href="{{ route('frontend.showPengumuman',$m->slug) }}" class="btn btn-default commonBtn">
                                View Details
                            </a>
                        </div>
