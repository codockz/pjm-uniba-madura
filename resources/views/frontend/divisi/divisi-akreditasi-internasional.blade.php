...
<div class="col-xs-12 col-sm-12" style="margin-bottom: 50px;">
    <div class="content_left features">
       ...
       @endphp
        ...
        @else
        <center><h1 style="margin-bottom: 20px;">Divisi Akreditasi Internasional</h1></center>
        @endif
        <div class="row">
        ...
        @empty
        <center><h1 style="padding: 100px;">Tidak Ada Data Akreditasi Internasional</h1></center>
    @endforelse
