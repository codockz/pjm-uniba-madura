            ...
            <div class="card-body">
                ...
                @if ($data->count() > 0)
                    <div class="table-responsive">
                        <table id="tableStandar" class="table table-bordered table-hover align-middle text-center">
                                ...
                                @foreach ($data as $item)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <form action="{{ route('admin.standar.destroy', $item->id) }}" method="POST"
                                                class="d-inline">
                                                @csrf
                                                @method('DELETE')
    ...
    <div class="modal fade" id="modalCreate" tabindex="-1">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="{{ route('admin.standar.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
        ...
        <div class="modal fade" id="modalEdit{{ $item->id }}" tabindex="-1">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form action="{{ route('admin.standar.update', $item->id) }}" method="POST"
