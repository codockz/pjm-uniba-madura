                            ...
                            @foreach ($data as $item)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <form action="{{ route('admin.rencana_induk_pengembangan.destroy', $item->id) }}"
...
<div class="modal fade" id="modalCreate">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="{{ route('admin.rencana_induk_pengembangan.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
...
<div class="modal fade" id="modalEdit{{ $item->id }}">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="{{ route('admin.rencana_induk_pengembangan.update', $item->id) }}"
