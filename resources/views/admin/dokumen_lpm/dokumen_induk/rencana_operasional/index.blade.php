...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h3 class="mb-0">Data Rencana Operasional</h3>
            ...
            <div class="card-body">
                ...
                @if ($data->count() > 0)
                    <div class="table-responsive">
                        <table id="tableOperasional" class="table table-bordered table-hover align-middle text-center">
                                ...
                                @foreach ($data as $item)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            {{-- TOGGLE --}}
                                            <form action="{{ route('admin.rencana_operasional.toggle', $item->id) }}"
                                            ...
                                            {{-- DELETE --}}
                                            <form action="{{ route('admin.rencana_operasional.destroy', $item->id) }}"
                                                method="POST" class="d-inline">
                                                @csrf
                                                @method('DELETE')
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <h5 class="modal-title">Tambah Data Rencana Operasional</h5>
                    <button class="btn-close" data-bs-dismiss="modal"></button>
                </div>

                <form action="{{ route('admin.rencana_operasional.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
        ...
        <div class="modal fade" id="modalEdit{{ $item->id }}" tabindex="-1">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form action="{{ route('admin.rencana_operasional.update', $item->id) }}" method="POST"
    ...
    @push('scripts')
        <script>
            ...
            $(document).ready(function() {
                let table = initDataTable('#tableOperasional');
