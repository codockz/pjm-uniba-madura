            ...
            <div class="card-body">
                ...
                @if ($data->count() > 0)
                    <div class="table-responsive">
                        <table id="tableRenstraLembaga" class="table table-bordered table-hover align-middle text-center">
                                ...
                                @foreach ($data as $item)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            {{-- 🔥 TOGGLE --}}
                                            <form action="{{ route('admin.rencana_strategis_lembaga.toggle', $item->id) }}"
                                            ...
                                            {{-- DELETE --}}
                                            <form
                                                action="{{ route('admin.rencana_strategis_lembaga.destroy', $item->id) }}"
                                                method="POST" class="d-inline">
                                                @csrf
                                                @method('DELETE')
                ...
                @else
                    <div class="alert alert-info text-center">
                        Belum ada data Rencana Strategis Lembaga.
                    </div>
                @endif
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <h5 class="modal-title">Tambah Data Rencana Strategis Lembaga</h5>
                    <button class="btn-close" data-bs-dismiss="modal"></button>
                </div>

                <form action="{{ route('admin.rencana_strategis_lembaga.store') }}" method="POST"
        ...
        <div class="modal fade" id="modalEdit{{ $item->id }}" tabindex="-1">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form action="{{ route('admin.rencana_strategis_lembaga.update', $item->id) }}" method="POST"
                        enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
    ...
    @push('scripts')
        <script>
            ...
            $(document).ready(function() {
                let table = initDataTable('#tableRenstraLembaga');
