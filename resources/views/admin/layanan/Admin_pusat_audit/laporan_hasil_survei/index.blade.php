...
@section('content')
                                ...
                                @foreach ($data as $item)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            {{-- TOGGLE --}}
                                            <form action="{{ route('admin.laporan_hasil_survei.toggle', $item->id) }}"
                                            ...
                                            {{-- DELETE --}}
                                            <form action="{{ route('admin.laporan_hasil_survei.destroy', $item->id) }}"
                                                method="POST" class="d-inline">
                                                @csrf
                                                @method('DELETE')
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <h5 class="modal-title">Tambah Laporan Hasil Survei</h5>
                    <button class="btn-close" data-bs-dismiss="modal"></button>
                </div>

                <form action="{{ route('admin.laporan_hasil_survei.store') }}" method="POST"
        ...
        <div class="modal fade" id="modalEdit{{ $item->id }}" tabindex="-1">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form action="{{ route('admin.laporan_hasil_survei.update', $item->id) }}" method="POST"
                        enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
    ...
    @push('scripts')
        <script>
            $(function() {
                let table = initDataTable('#tableSurvei');
