                                ...
                                @foreach ($data as $item)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            {{-- TOGGLE --}}
                                            <form action="{{ route('admin.jadwal_ami.toggle', $item->id) }}" method="POST"
                                                class="d-inline">
                                                @csrf
                                                <button
                                            ...
                                            {{-- DELETE --}}
                                            <form action="{{ route('admin.jadwal_ami.destroy', $item->id) }}"
    ...
    <div class="modal fade" id="modalCreate" tabindex="-1">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="{{ route('admin.jadwal_ami.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
        ...
        <div class="modal fade" id="modalEdit{{ $item->id }}" tabindex="-1">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form action="{{ route('admin.jadwal_ami.update', $item->id) }}" method="POST"
