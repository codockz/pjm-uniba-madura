...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h3 class="mb-0">Data Laporan Monev</h3>
            ...
            <div class="card-body">
                ...
                @if ($data->count() > 0)
                    <div class="table-responsive">
                        <table id="tableLaporanMonev" class="table table-bordered table-hover align-middle text-center">
                                ...
                                @foreach ($data as $item)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            {{-- TOGGLE --}}
                                            <form action="{{ route('admin.laporan_monev.toggle', $item->id) }}"
                                            ...
                                            {{-- DELETE --}}
                                            <form action="{{ route('admin.laporan_monev.destroy', $item->id) }}"
                                                method="POST" class="d-inline">
                                                @csrf
                                                @method('DELETE')
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <h5 class="modal-title">Tambah Laporan Monev</h5>
                    <button class="btn-close" data-bs-dismiss="modal"></button>
                </div>

                <form action="{{ route('admin.laporan_monev.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
        ...
        <div class="modal fade" id="modalEdit{{ $item->id }}" tabindex="-1">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form action="{{ route('admin.laporan_monev.update', $item->id) }}" method="POST"
    ...
    @push('scripts')
        <script>
            $(function() {
                let table = initDataTable('#tableLaporanMonev');
