            ...
            <div class="card-body">
                ...
                @if ($data->count() > 0)
                    <div class="table-responsive">
                        <table id="tableKpmGpm" class="table table-bordered table-hover align-middle text-center">
                                ...
                                @foreach ($data as $item)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            {{-- TOGGLE --}}
                                            <form action="{{ route('admin.kpm_gpm.toggle', $item->id) }}" method="POST"
                                                class="d-inline">
                                                @csrf
                                                <button
                                            ...
                                            {{-- DELETE --}}
                                            <form action="{{ route('admin.kpm_gpm.destroy', $item->id) }}" method="POST"
                                                class="d-inline">
                                                @csrf
                                                @method('DELETE')
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <h5 class="modal-title">Tambah Data KPM GPM</h5>
                    <button class="btn-close" data-bs-dismiss="modal"></button>
                </div>

                <form action="{{ route('admin.kpm_gpm.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
        ...
        <div class="modal fade" id="modalEdit{{ $item->id }}" tabindex="-1">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form action="{{ route('admin.kpm_gpm.update', $item->id) }}" method="POST"
    ...
    @push('scripts')
        <script>
            ...
            $(document).ready(function() {
                ...
                let table = initDataTable('#tableKpmGpm');
