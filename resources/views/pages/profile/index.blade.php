                ...
                <div class="modal-body">
                    <form id="add_form">
                        ...
                        <div class="form-group">
                            <label for="profile">Isi Profile</label>
                            <textarea name="profile" id="profile" rows="3" class="form-control"></textarea>
                            <div class="invalid-feedback" id="profile-error">
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.status == 200) {
                        trObj.find(".editSpan.profile").text(response.data);
                        trObj.find(".editInput.profile").val(response.data);
