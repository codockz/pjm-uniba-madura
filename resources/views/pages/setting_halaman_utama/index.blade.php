...
@section('content')
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <button type="button" class="btn btn-primary btn-sm mb-2" data-toggle="modal"
                            ...
                            + Tambah Gambar Slide, judul dan isi
                        </button>
                        <button type="button" class="btn btn-primary btn-sm mb-2" data-toggle="modal"
                            data-target="#footer">
                         ...
                         <button type="button" class="btn btn-primary btn-sm mb-2" data-toggle="modal"
                            data-target="#judul_gambar_isi">
                            Tambah setting gambar halaman lain
                        </button>
                        <button type="button" class="btn btn-primary btn-sm mb-2" data-toggle="modal"
                    ...
                    <div class="card-body">
                        <form id="form_about">
                            <div class="form-group">
                                ...
                                <input type="text" name="link_video" id="link_video" class="form-control mb-2" @if(!empty($about)) value="{{ $about->link_video }}" @endif>
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="isi" id="isi" class="form-control mb-2" cols="30" rows="10"> @if(!empty($about)) {{ $about->isi }} @endif</textarea>
                ...
                <div class="modal-body">
                    <form id="add_form_footer" class="row">
                        ...
                        <div class="form-group col-12">
                            ...
                            <input type="hidden" name="old_id" @if($setting_footer) value="{{ $setting_footer->id }} @endif">
                            <input name="name" id="name" class="form-control" @if($setting_footer) value="{{ $setting_footer->name }} @endif">
                        ...
                        <div class="form-group col-6">
                            ...
                            <input name="lokasi" id="lokasi" class="form-control" @if($setting_footer) value="{{ $setting_footer->lokasi }} @endif">
                        ...
                        <div class="form-group col-6">
                            ...
                            <input name="g_map" id="g_map" class="form-control"  @if($setting_footer) value="{{ $setting_footer->g_map }} @endif">
                        ...
                        <div class="form-group col-12">
                            ...
                            <input name="facebook" id="facebook" class="form-control"  @if($setting_footer) value="{{ $setting_footer->facebook }} @endif">
                        ...
                        <div class="form-group col-12">
                            ...
                            <input name="instagram" id="instagram" class="form-control" @if($setting_footer) value="{{ $setting_footer->instagram }} @endif">
                        ...
                        <div class="form-group col-12">
                            ...
                            <input name="youtube" id="youtube" class="form-control"  @if($setting_footer) value="{{ $setting_footer->youtube }} @endif">
                        ...
                        <div class="form-group col-12">
                            ...
                            <input name="no_telp" id="no_telp" class="form-control" @if($setting_footer) value="{{ $setting_footer->no_telp }} @endif">
                ...
                <form id="add_form" class="row">
                    ...
                    <div class="form-group col-sm-4 mb-2">
                        <img src="https://dummyimage.com/hd1080"
                            id="ba" alt="your image" width="150" height="150">
                    </div>
            </div>
            <div class="modal-footer">
                <button type="submit" class="btn btn-primary">Simpan</button>
            ...
            <div class="modal-body">
                <form id="add_form_judul_gambar_isi" class="row">
                    ...
                    <div class="form-group col-sm-8">
                        ...
                        <input type="file" class="form-control" name="gambar" id="input_gambar" onchange="previewImage()">
                        <div class="invalid-feedback " id='input_gambar-error'></div>
                    </div>
                    <div class="form-group col-sm-4 mb-2">
                        <img src="https://dummyimage.com/hd1080" id="preview_gambar" alt="your image" width="150" height="150">
                    </div>
            </div>
            <div class="modal-footer">
                <button type="submit" class="btn btn-primary">Simpan</button>
 ...
 <div class="modal fade" id="editModalJudulGambarIsi" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
    <div class="modal-dialog" role="document">
       <div class="modal-content">
           <div class="modal-header">
           ...
           <div class="modal-body">
               <form id="edit_form_2" class="row">
                   ...
                   <div class="form-group col-sm-4 mb-2">
                       <img
                           id="file_gambar_edit" alt="your image" width="100" height="100">
                   </div>
           </div>
           <div class="modal-footer">
               <button type="submit" class="btn btn-primary">Simpan</button>
   ...
   <div class="modal fade" id="data_judul_gambar_isi" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
    ...
    <script>
          ...
          $('#example1').on('click', '.edit-button', function() {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $('#ba_edit').attr('src',"{{ asset('gambar_slide') }}/" + response.data.gambar_slide);
                },
            });
        });
        ...
        $('#edit_form').on('submit', function(e) {
            e.preventDefault();
            var formData = new FormData(this);
            var url = "{{ route('juduL_gambar_isi.getData') }}";
            $('#btn_add').prop('disabled', true);
            $.ajax({
                type: 'POST',
                url: url,
        ...
        $('#example2').on('click', '.edit-button', function() {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $('#file_gambar_edit').attr('src',"{{ asset('file_gambar_halaman_lain') }}/" + response.data.gambar);
                },
            });
        });
